...
function draw() {
  ...
  text ('Fergus Arundel',width/1.1505532,height-40);
...
function eyebrows(){
  ...
  noStroke();
  fill(0);
  ellipse (x,height-75,13,13+eyesAnimation);
  ellipse (x+40,height-75,13,13+eyesAnimation);

  push();
  translate (80,height-92);
  scale (-1,1);
  rotate (-angryAnimation);
  rect(0,0-eyebrowAnimation/2,20,4,10)
  pop();

  push();
  translate (100,height-92);
  rotate (-angryAnimation);
  rect(0,0-eyebrowAnimation/2,20,4,10)
  pop();

  push ();
  rect (70,height-52,40,9+mouthAnimation,4);
  pop();
